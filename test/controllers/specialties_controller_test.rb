...
class SpecialtiesControllerTest < ActionController::TestCase
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post :create, specialty: { code: @specialty.code, gen: @specialty.gen, level: @specialty.level, title: @specialty.title }
    end
  ...
  test "should update specialty" do
    patch :update, id: @specialty, specialty: { code: @specialty.code, gen: @specialty.gen, level: @specialty.level, title: @specialty.title }
    assert_redirected_to specialty_path(assigns(:specialty))
  end
